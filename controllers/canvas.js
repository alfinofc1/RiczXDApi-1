...
async function Spongebob(req, res) {
  ...
  if (avatar === undefined || apikey === undefined) {
    ...
    const img = await new knights.Burn().setAvatar(avatar).toAttachment();
...
async function Patrick(req, res) {
  ...
  if (avatar === undefined || apikey === undefined) {
    ...
    const img = await new knights.Patrick().setAvatar(avatar).toAttachment();
    let Buffering = img.toBuffer();
    await fs.writeFile(tmp + ".png", Buffering, (err) => {
      if (err) return res.send({ message: "failed Write Image Next Try" });
      res.sendFile(tmp + ".png");
...
async function LevelUp(req, res) {
  ...
  if (avatar === undefined || apikey === undefined) {
    ...
    const img = await new knights.Up().setAvatar(avatar).toAttachment();
    let Buffering = img.toBuffer();
    await fs.writeFile(tmp + ".png", Buffering, (err) => {
      if (err) return res.send({ message: "failed Write Image Next Try" });
      res.sendFile(tmp + ".png");
...
async function Rank(req, res) {
  ...
  if (
    ...
    res.status(403).send({
      status: 403,
      message:
        "masukan parameter username & avatar & xp & exp & level & background & apikey",
    });
  } else {
    const check = await cekKey(apikey);
    if (!check)
...
async function welcome(req, res) {
  ...
  if (
    ...
    res.status(403).send({
      status: 403,
      message:
        "masukan parameter username & groupname & groupicon & membercount & profile & background & apikey",
    });
  } else {
    const check = await cekKey(apikey);
    if (!check)
...
async function leave2(req, res) {
  ...
  if (
    ...
    res.status(403).send({
      status: 403,
      message:
        "masukan parameter username & groupicon & membercount & profile & background & apikey",
    });
  } else {
    const check = await cekKey(apikey);
    if (!check)
...
async function kissRouter(req, res) {
  ...
  if (url === undefined || apikey === undefined || url2 === undefined)
...
async function kaneki(req, res) {
  ...
  if (q === undefined || apikey === undefined) {
    ...
    let img = await new knights.Gfx1().setName(q).toAttachment();
    let buffering = img.toBuffer();
...
async function loli(req, res) {
  ...
  if (q === undefined || apikey === undefined) {
    ...
    let img = await new knights.Gfx2().setName(q).toAttachment();
    let buffering = img.toBuffer();
    fs.writeFile(tmp + ".png", buffering, (err) => {
      if (err)
        return res.status(400).send({
...
async function sadboy(req, res) {
  ...
  if (q === undefined || apikey === undefined || q2 === undefined) {
    ...
    let img = await new knights.Gfx3().setText1(q).setText2(q2).toAttachment();
    let buffering = img.toBuffer();
    fs.writeFile(tmp + ".png", buffering, (err) => {
      if (err)
        return res.status(400).send({
...
async function girlNeko(req, res) {
  ...
  if (q === undefined || apikey === undefined || q2 === undefined) {
    ...
    let img = await new knights.Gfx4().setText1(q).setText2(q2).toAttachment();
    let buffering = img.toBuffer();
    fs.writeFile(tmp + ".png", buffering, (err) => {
      if (err)
        return res.status(400).send({
...
async function rem(req, res) {
  ...
  if (q === undefined || apikey === undefined) {
    ...
    let img = await new knights.Gfx5().setText(q).toAttachment();
    let buffering = img.toBuffer();
    fs.writeFile(tmp + ".png", buffering, (err) => {
      if (err)
        return res.status(400).send({
...
async function customGfx(req, res) {
  ...
  if (q === undefined || apikey === undefined || bg === undefined) {
    ...
    let img = await new knights.customGfx().setText(q).setBg(bg).toAttachment();
    let buffering = img.toBuffer();
    fs.writeFile(tmp + ".png", buffering, (err) => {
      if (err)
        return res.status(400).send({
...
async function slapRouter(req, res) {
  ...
  slap(url, url2)
    .then(async (buffer) => {
      const toWebp = await sticker(
        buffer,
        null,
        "triggred from rest api",
        "hardianto.xyz",
      );
